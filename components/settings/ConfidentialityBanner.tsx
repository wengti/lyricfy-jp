...
export default function ConfidentialityBanner() {
  return (
    <div className="mb-8 flex gap-3 rounded-xl border border-amber-300 bg-amber-50 px-5 py-4 dark:border-amber-800 dark:bg-amber-900/20">
      <ShieldAlert size={20} className="mt-0.5 shrink-0 text-amber-600 dark:text-amber-500" />
      <div>
        <p className="font-semibold text-amber-800 dark:text-amber-300">Keep your API keys private</p>
