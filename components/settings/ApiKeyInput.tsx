    ...
    <div>
      ...
      <div className="relative flex items-center">
        <input
          ...
          autoComplete="off"
          className="w-full rounded-lg border border-gray-300 py-2 pl-3 pr-10 text-base font-mono outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 dark:placeholder-gray-500 dark:focus:ring-indigo-800"
        />
        <button
          type="button"
          onClick={() => setShow((s) => !s)}
