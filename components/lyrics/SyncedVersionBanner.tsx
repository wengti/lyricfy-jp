...
export default function SyncedVersionBanner({
  ...
  return (
    <div className="mb-4 rounded-lg border border-blue-200 bg-blue-50 dark:border-blue-800 dark:bg-blue-900/20">
      {lines ? (
        /* Synced version found — expandable with preview and action */
        <button
          type="button"
        ...
        >
          ...
          <svg
            ...
            viewBox="0 0 20 20"
            fill="currentColor"
            className={`h-4 w-4 shrink-0 text-blue-500 transition-transform dark:text-blue-400 ${expanded ? 'rotate-180' : ''}`}
          >
            <path fillRule="evenodd" d="M5.22 8.22a.75.75 0 0 1 1.06 0L10 11.94l3.72-3.72a.75.75 0 1 1 1.06 1.06l-4.25 4.25a.75.75 0 0 1-1.06 0L5.22 9.28a.75.75 0 0 1 0-1.06Z" clipRule="evenodd" />
          </svg>
        </button>
      ) : (
        /* No synced version found — static informational note */
        <div className="flex items-center gap-2 px-4 py-3">
          ...
          <span className="text-sm text-gray-500 dark:text-gray-400">
            Checked lrclib.net — no synced version available yet.
          </span>
        </div>
      )}
